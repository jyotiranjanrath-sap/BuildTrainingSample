...
class Builder {
    ...
    constructor(args) {
        ...
        instance.sBundleTempFolder = instance.buildArgs.bundleDefinitionPath() ? instance.buildArgs.bundleDefinitionPath() : path.join(utils.getRootPath(),"..","out", path.basename(this.buildArgs.project()));
    }
    /**
