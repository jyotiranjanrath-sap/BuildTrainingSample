...
class Builder {
    ...
    constructor(args) {
        ...
        instance.sBundleTempFolder = path.join(instance.buildArgs.project(), utils.BUILD_TEMP_FOLDER);
    }
    /**
     ...
     build() {
        return new Promise(function (resolve, reject) {
            try {
                ...
                const applicationFile = path.join(sProjectPath, utils.APPLICATION_FILE);
