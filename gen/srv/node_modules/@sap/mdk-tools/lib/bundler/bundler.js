 ...
 */
  ...
  _buildApplicationBundle() {
    return new Promise(function (resolve, reject) {
      ...
      const safeNsImports = ['ui', 'trace', 'connectivity', 'color', 'platform', 'utils', 'fps-meter', 'http', 'profiling', 'image-source', 'core-types', 'application', 'file-system', 'application-settings', 'xml','accessibility'];
 ...
 */
  _isValidBundleFile(sFilePath) {
    ...
    if (sFilePath.includes('DS_Store')
      ...
      // We don't need to include it in the bundle and it causes an error
      || sFilePath.includes('references.d.ts')
