...
class Builder {
    constructor(args) {
        ...
        this.sBundleTempFolder = this.buildArgs.bundleDefinitionPath() ? this.buildArgs.bundleDefinitionPath() : path.join(utils.getRootPath(),"..", "out", path.basename(this.buildArgs.project()));
    }
    /**
            ...
            if (!zipEntry.isDirectory) {
                ...
                if (!instance.isModule) {
                    ...
                    for (i = 0; i < arrParts.length; i++) {
                        ...
                        if (arrParts[i].endsWith("-info")) {
                            arrParts[i] = appName + "-info";
                        }
                    }
