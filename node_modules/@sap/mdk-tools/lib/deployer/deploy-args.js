        ...
        optionList: [
          {
            name: 'target',
            typeLabel: '',
            description: '[common] Type of the deploy target, it can be mobile or cf for web deplopyment.'
          },
          {
            name: 'name',
            typeLabel: '',
            description: '[common] the app name in target cloud'
          },
          {
            name: 'project',
          ...
          },
          {
            name: 'logFile',
            typeLabel: '',
            description: '[common] The file to log.'
          },
          {
            name: 'runtime',
            typeLabel: '',
...
exports.logFile = function () {
  if (options['logFile']) {
    return path.resolve(options['logFile']);
  } else {
   return "";
  }
}
